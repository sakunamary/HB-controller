...
{
public:
    SerialCommand(HardwareSerial &HardSer);     // Constructor
...
private:
    ...
    int numCommand;
    SerialCommandCallback CommandList[MAXSERIALCOMMANDS + 1]; // Actual definition for command/handler array
    void (*defaultHandler)();                                 // Pointer to the default handler function
    HardwareSerial *HardSerial;                               // Pointer to a user-created HardwareSerial object
};
